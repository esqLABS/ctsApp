...
2. **Number of Individuals**: Set the number of virtual individuals (1-100). Note that higher numbers require more memory and increase simulation time.
...
3. The simulation creates two scenarios:
   - **Victim Simulation**: Victim compound alone (+ EE if enabled)
...
- Concentration-time profile for the victim compound (with and without perpetrator)
- Concentration-time profile for perpetrator (if toggle is enabled)
